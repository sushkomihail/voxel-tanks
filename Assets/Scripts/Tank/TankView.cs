...
namespace Tank
{
    ...
    public class TankView : MonoBehaviour, IOutlineTrigger
    {
        ...
        public void UpdateHudHealthBar(int currentHealth, int maxHealth)
        {
        ...
        public void UpdateOverTankHealthBar(int currentHealth, int maxHealth)
        {
            float healthPercent = Mathf.Clamp01((float)currentHealth / maxHealth);
