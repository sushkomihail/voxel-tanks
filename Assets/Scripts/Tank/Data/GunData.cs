...
namespace Tank.Data
{
    ...
    public class GunData
    {
        ...
        [SerializeField] private int _projectileTrajectoryPredictionIterations = 100;
        ...
        public int ProjectileTrajectoryPredictionIterations => _projectileTrajectoryPredictionIterations;
